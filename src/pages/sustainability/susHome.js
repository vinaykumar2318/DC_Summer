...
const Sustainability = () => {
  return (
    <div className="flex flex-col w-11/12 sm:w-4/5 md:w-3/4 rounded-xl mx-auto bg-white">
      ...
      <div className="flex flex-col md:flex-row justify-around p-4 sm:p-6 mb-6 sm:mb-8 bg-[#E3F2FD] rounded-2xl shadow-md gap-4 sm:gap-6 items-stretch">
        <Link href="/sustainability/projectsOIE" className="flex-1 min-w-[200px]">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer text-center h-full flex items-center justify-center">
            <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-blue-700">
              CAMPUS SUSTAINABILITY PROJECTS WITH OIE
            </h3>
          </div>
        </Link>
        <Link href="/sustainability/netZero" className="flex-1 min-w-[200px]">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer flex items-center justify-center text-center h-full">
            <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-blue-700">NET ZERO</h3>
          </div>
        </Link>
        <Link href="/sustainability/assessmentTool" className="flex-1 min-w-[200px]">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer flex items-center justify-center text-center h-full">
            <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-blue-700">SUSTAINABILITY ASSESSMENT</h3>
          </div>
        </Link>
      </div>

      <div className="w-full p-4 sm:p-6 bg-[#E3F2FD] mb-6 sm:mb-8 rounded-2xl space-y-4 sm:space-y-6 shadow-md">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700">Sustainability Plan</h2>
        ...
        <h4 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">Overarching Goal</h4>
      ...
      <div className="w-full p-4 sm:p-6 bg-[#E3F2FD] mb-6 sm:mb-8 rounded-2xl shadow-md">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700 mb-4">
          Environmental and Social Sustainability Training/Workshop/Events 2024-2025
        </h2>
        <ul className="list-disc list-inside text-gray-700 space-y-2 text-base sm:text-lg">
          <li>
            <Link
              target="_blank"
              href="https://www.instagram.com/p/DAigkfvTa3J/?igsh=MTFqMjc1MWdlOXVrYg%3D%3D"
          ...
          <li>
            <Link
              target="_blank"
              href="https://www.instagram.com/p/DAiDuFeTWN-/?igsh=MnEyb3ozZDg5Ym41"
              className="text-blue-600 hover:text-blue-800 hover:underline transition-colors"
            >
          ...
          <li>
            <Link
              target="_blank"
              href="https://www.instagram.com/p/DAiknKQzPHv/?igsh=MXJlajdwOTBpem15cA%3D%3D"
              className="text-blue-600 hover:text-blue-800 hover:underline transition-colors"
            >
              Zero Waste Marathon
            </Link>
          ...
          <li>
            <Link
              target="_blank"
              href="https://www.instagram.com/p/DAYUny7zo6L/?igsh=aHI1cDcybzhrc2Fz"
              className="text-blue-600 hover:text-blue-800 hover:underline transition-colors"
            >
      ...
      <div className="w-full p-4 sm:p-6 bg-[#E3F2FD] mb-6 sm:mb-8 rounded-2xl space-y-4 sm:space-y-6 shadow-md">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700">Environmental Sustainability</h2>
        <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-800">Training/Workshop/Events</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <Link target="_blank" key={index} href={item.link} className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <p className="text-base sm:text-md text-gray-800 hover:text-blue-600 transition-colors">
                {item.title}
              </p>
            </Link>
          ))}
      ...
      <div className="w-full p-4 sm:p-6 bg-[#E3F2FD] mb-6 sm:mb-8 rounded-2xl space-y-4 sm:space-y-6 shadow-md">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700">Social Sustainability</h2>
        <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-800">Training/Workshop/Events</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            {
      ...
      <div className="w-full p-4 sm:p-6 bg-[#E3F2FD] mb-6 sm:mb-8 rounded-2xl space-y-4 sm:space-y-6 shadow-md">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700">Geographic Setting</h2>
        <p className="text-base sm:text-lg text-gray-700">
      ...
      <div className="w-full p-4 sm:p-6 bg-[#E3F2FD] mb-6 sm:mb-8 rounded-2xl space-y-4 sm:space-y-6 shadow-md">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700">Evolution of the Sustainability Center</h2>
        <p className="text-base sm:text-lg text-gray-700">
      ...
      <div className="w-full p-4 sm:p-6 bg-[#E3F2FD] mb-6 sm:mb-8 rounded-2xl shadow-md">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700 mb-4 sm:mb-6">Carbon Emissions</h2>
        <div className="mb-6 sm:mb-8">
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">Carbon Emissions Audit 2019-20</h3>
          <Link target="_blank" href="http://172.16.100.160:8080/IDRP_Admin/Carbon%20footprint%202019-20%20IIT%20Jodhpur.pdf">
            <h4 className="text-base sm:text-lg hover:underline font-semibold text-gray-800 mt-2">Carbon Footprint</h4>
          </Link>
          ...
          <div className="mt-4">
            <ul className="list-disc list-inside text-gray-700 space-y-1 mt-2 text-base sm:text-lg">
              <Link target="_blank" href="http://172.16.100.160:8080/IDRP_Admin/CO2%20emmision%20scope%201%20IITJ.pdf">
                <li className='text-blue-600 hover:text-blue-800 hover:underline transition-colors'>Scope 1</li>
              </Link>
              <Link target="_blank" href="http://172.16.100.160:8080/IDRP_Admin/CO2%20emmision%20scope%202%20IITJ.pdf">
                <li className='text-blue-600 hover:text-blue-800 hover:underline transition-colors'>Scope 2</li>
              </Link>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-4 sm:pt-6 border-t border-gray-300">
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">Carbon Emission Audit 2023-24</h3>
          <div className="mt-4">
            <Link target="_blank" href="https://cetsd.iitj.ac.in/wp-content/uploads/2024/04/Indian-Institute-of-Technology-Jodhpur_-Carbon-emission-calculation-2023_2024.pdf" className="text-blue-600 hover:text-blue-800 hover:underline transition-colors">
              <p className="text-base sm:text-lg mt-2">Report on Managing Carbon Footprint 2023-2024 of IITJ</p>
            </Link>
          </div>
        </div>
      </div>
