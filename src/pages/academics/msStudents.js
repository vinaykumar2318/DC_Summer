        ...
        <>
            <div className="flex flex-col w-11/12 sm:w-4/5 md:w-3/4 rounded-xl mx-auto bg-white">
                <div className="w-full p-6 bg-[#E3F2FD] mb-8 rounded-2xl space-y-6 shadow-md">
                    <h2 className="text-2xl sm:text-3xl font-bold text-blue-700">M.S. by Research Program</h2>
                    ...
                    <p className="text-gray-700 text-base sm:text-lg md:text-xl">
                        ...
                        <Link href="/people/ms" className="text-blue-600 hover:text-blue-800 hover:underline">
                            here
                        </Link>.
                    </p>
                </div>
                ...
                <div className="w-full p-6 bg-[#E3F2FD] mb-8 rounded-2xl space-y-6 shadow-md">
                    <h2 className="text-2xl sm:text-3xl font-bold text-blue-700">Important Links</h2>
                    <ul className="list-disc list-inside text-gray-700 space-y-4 text-base sm:text-lg md:text-xl">
                        <li>
                            <Link
                                target="_blank"
                                href="https://drive.google.com/file/d/1Ly8yisV0jVso2zabdoUEsdCSbTbLjRfm/view"
                        ...
                        <li>
                            <Link
                                target="_blank"
                                href="https://drive.google.com/file/d/15_M4W79KCtT3rvCtvHMIq6uT9nYi4Z2h/view"
                                className="text-blue-600 hover:text-blue-800 hover:underline"
                            >
                        ...
                        <li>
                            <Link
                                target="_blank"
                                href="https://drive.google.com/file/d/1_UQo6HevzBb55l45EysSLgnyfyR1aELT/view"
                                className="text-blue-600 hover:text-blue-800 hover:underline"
                            >
