        ...
        <>
            <div className="flex flex-col w-full sm:w-4/5 md:w-3/4 rounded-xl mx-auto bg-white">
                <div className="w-full p-6 bg-[#E3F2FD] mb-8 rounded-2xl space-y-6 shadow-md">
                    ...
                    <p className="text-gray-700 text-xl">
                        More information on the specific SDGs addressed by students in their research projects can be found <Link href="/people/phd" className="text-blue-600 hover:text-blue-800 underline">here</Link>.
                    </p>
                </div>
