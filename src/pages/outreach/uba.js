...
const UBA = () => {
  return (
    <>
      <div className="flex w-full sm:w-4/5 md:w-3/4 rounded-xl mx-auto min-h-screen">
        <div className="w-full p-6 bg-white rounded-2xl space-y-6">
            ...
            <div className="bg-[#E3F2FD] p-4 rounded-lg shadow flex flex-col items-center">
                <div>
                    <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700">Unnat Bharat Abhiyan (UBA)</h2>
            ...
            <div className="bg-[#E3F2FD] p-4 rounded-lg shadow">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700 mb-5">Our Inspirations</h2>
                <Image src="/UBA/quote.avif" width={1200} height={200} className='rounded-2xl'></Image>
            </div>

            <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b pb-4 gap-6">
                <div className="flex items-start md:items-center space-x-3">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-12 w-12 text-black flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    >
                ...
                <div className="flex items-start md:items-center space-x-3">
                    ...
                    <div className="text-sm text-gray-600">ngehlot@iitj.ac.in</div>
                    </div>
                </div>
            </div>
        </div>
