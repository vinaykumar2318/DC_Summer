        ...
        <>
            <div className="flex flex-col w-11/12 sm:w-4/5 md:w-3/4 rounded-xl mx-auto bg-white">
                <div className="w-full p-6 bg-[#E3F2FD] mb-8 rounded-2xl space-y-6 shadow-md">
                    <h2 className="text-2xl sm:text-3xl font-bold text-blue-700">Ph.D. Admission</h2>
                    ...
                    <p className="text-gray-700 text-base sm:text-lg md:text-xl">
                        More information on the specific SDGs addressed by students in their research projects can be found{' '}
                        <Link href="/people/phd" className="text-blue-600 hover:text-blue-800 hover:underline">
                            here
                        </Link>.
                    </p>
                </div>
                ...
                <div className="w-full p-6 bg-[#E3F2FD] mb-8 rounded-2xl space-y-6 shadow-md">
                    <h2 className="text-2xl sm:text-3xl font-bold text-blue-700">Application Details</h2>
                    <p className="text-gray-700 text-base sm:text-lg md:text-xl">
                        Applicants are requested to use the following links to fill and submit the application form online:
                    </p>
                    <ul className="list-disc list-inside text-gray-700 space-y-4 text-base sm:text-lg md:text-xl">
                        <li>
                            <Link
                                href="https://oa.iitj.ac.in/PG_ADMISSION"
                                target="_blank"
                        ...
                        <li>
                            <Link
                                href="https://oa.iitj.ac.in/OA_PG_ADMISSION_INTRNL/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-600 hover:text-blue-800 hover:underline"
                            >
                ...
                <div className="w-full p-6 bg-[#E3F2FD] mb-8 rounded-2xl space-y-6 shadow-md">
                    <h2 className="text-2xl sm:text-3xl font-bold text-blue-700">Additional Information</h2>
                    <ul className="list-disc list-inside text-gray-700 space-y-4 text-base sm:text-lg md:text-xl">
                        <li>
                            <Link
                                href="https://drive.google.com/file/d/177072UOU5WK5-BgmE-ywvqJ637neayN3/view?usp=sharing"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-600 hover:text-blue-800 hover:underline"
                            >
                        ...
                        <li>
                            <Link
                                href="https://drive.google.com/file/d/1kRBGN5yTke4wgnLJ-V2C5VJ1XleD91ZI/view?usp=sharing"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-600 hover:text-blue-800 hover:underline"
                            >
